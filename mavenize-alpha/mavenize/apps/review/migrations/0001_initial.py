...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('review_review', (
            ('review_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('table_number', self.gf('django.db.models.fields.IntegerField')()),
            ('table_id_in_table', self.gf('django.db.models.fields.IntegerField')()),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=240)),
        ...
        # Adding model 'Thanks'
        db.create_table('review_thanks', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('giver', self.gf('django.db.models.fields.IntegerField')()),
            ('review', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.Review'])),
        ))
        db.send_create_signal('review', ['Thanks'])
    ...
    models = {
        ...
        'review.thanks': {
            ...
            'giver': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
